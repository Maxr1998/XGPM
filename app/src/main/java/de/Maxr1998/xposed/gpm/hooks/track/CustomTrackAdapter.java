...
public class CustomTrackAdapter extends ArrayAdapter<TrackItem> {
    ...
    public CustomTrackAdapter(Context context, int position, List<TrackItem> list, PendingIntent replyIntent) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap art = getItem(position).getArt();
        if (art != null) {
        ...
        subtitleText.setText(getItem(position).getArtist());
